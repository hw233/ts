...
-define(EquipTypeArmor,1).								%%盔甲
-define(EquipTypeBoots,2).								%%靴子
-define(EquipTypeRing,3).								%%戒指
-define(EquipTypeNecklace,4).							%%项链
-define(EquipTypeEarring,5).							%%耳坠
-define(EquipTypeTalisman,6).							%%护符
-define(EquipTypeEarrings,7).							%%耳环
-define(EquipTypeMax,7).								%%装备最大分类值

-type equipPosType() :: 0 .. 7.

%%装备类型对周围玩家可见
-define(EquipTypeVisibleOfOtherPlayer,[?EquipTypeWeapon,
	?EquipTypeEarrings,
	?EquipTypeArmor,
	?EquipTypeBoots]).
%%可见装备广播类型
