...
-define(ItemSourceMarriageDailyPrize, 	87).%%已婚人士每日上线奖励
...
-define(CoinSourceMarriageEngage, 	10032).%%姻缘：主动解除婚约补偿
-define(CoinSourceMarriageEngageSys, 	10033).%%姻缘：系统解除婚约补偿
...
-define(CoinUseMarriageEngage, 	10055).%%姻缘：建立婚约
-define(CoinUseMarriageBreakForcibly, 	10056).%%姻缘：强制离婚
-define(CoinUseMarriageWeddingFlower, 	10057).%%姻缘：婚礼鲜花
-define(CoinUseMarriageWeddingCandy, 	10058).%%姻缘：婚礼糖果
