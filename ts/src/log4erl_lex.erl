-file("c:/PROGRA~2/ERL510~1.4/lib/parsetools-2.0.10/include/leexinc.hrl", 0).
...
-file("src/common/log/src/log4erl_lex.xrl", 19).

strip(TokenChars,TokenLen) -> 
    lists:sublist(TokenChars, 2, TokenLen - 2).

-file("c:/PROGRA~2/ERL510~1.4/lib/parsetools-2.0.10/include/leexinc.hrl", 14).
...
-file("src/common/log/src/log4erl_lex.xrl", 8).
yyaction_0(TokenChars, TokenLine) ->
     { token, { loger, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/common/log/src/log4erl_lex.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { default, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/common/log/src/log4erl_lex.xrl", 10).
yyaction_2(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("src/common/log/src/log4erl_lex.xrl", 11).
yyaction_3(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/3}).
-file("src/common/log/src/log4erl_lex.xrl", 12).
yyaction_4(TokenChars, TokenLen, TokenLine) ->
     { token, { val, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_5/3}).
-file("src/common/log/src/log4erl_lex.xrl", 13).
yyaction_5(TokenChars, TokenLen, TokenLine) ->
     { token, { val, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_6/2}).
-file("src/common/log/src/log4erl_lex.xrl", 14).
yyaction_6(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_7/0}).
-file("src/common/log/src/log4erl_lex.xrl", 15).
yyaction_7() ->
     skip_token .

-file("c:/PROGRA~2/ERL510~1.4/lib/parsetools-2.0.10/include/leexinc.hrl", 282).
