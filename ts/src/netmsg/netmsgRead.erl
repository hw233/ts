...
readNetMsg(?CMD_GS2U_SevenMissionDataUpdate,Bin0) ->
	...
	{ V_number, Bin2 } = binary_read_uint8( Bin1 ),
	{ V_max, Bin3 } = binary_read_uint8( Bin2 ),
...
readNetMsg(?CMD_GS2U_LookRPInfo_Result,Bin0) ->
	...
	{ V_level, Bin3 } = binary_read_uint8( Bin2 ),
	{ V_roleForce, Bin4 } = binary_read_uint( Bin3 ),
	{ V_equipHonorLevel, Bin5 } = binary_read_uint8( Bin4 ),
	{ V_activePart, Bin6 } = binary_read_uint8( Bin5 ),
	{ V_guildName, Bin7 } = binary_read_string( Bin6 ),
	{ V_guileLevel, Bin8 } = binary_read_uint8( Bin7 ),
	{ V_vipLevel, Bin9 } = binary_read_int16( Bin8 ),
	{ V_playerKillValue, Bin10 } = binary_read_int( Bin9 ),
	{ V_wingLevel, Bin11 } = binary_read_int( Bin10 ),
	{ V_arenaVal, Bin12 } = binary_read_int( Bin11 ),
	{ V_titleList, Bin13 } = binary_read_array(Bin12, fun(X) -> binary_read_uint( X ) end),
	...
	{ V_gemInfo, Bin16 } = binary_read_array(Bin15, fun(X) -> readLookGemInfo( X ) end),
	{ V_fashionList, Bin17 } = binary_read_array(Bin16, fun(X) -> binary_read_uint( X ) end),
	{ V_wakeInfo, Bin18 } = binary_read_array(Bin17, fun(X) -> readLookWakeInfo( X ) end),
	{ V_weaponInfo, Bin19 } = binary_read_array(Bin18, fun(X) -> readLookGodWeaponInfo( X ) end),
	{ V_petInfo, Bin20 } = readLookPetInfo( Bin19 ),
	{ V_equipRefines, Bin21 } = binary_read_array(Bin20, fun(X) -> readEquipRefineLevel( X ) end),
	{ V_equipStar, Bin22 } = binary_read_array(Bin21, fun(X) -> readEquipStarLevel( X ) end),
	{ V_personalityInfo, Bin23 } = readPlayerPersonalityInfo( Bin22 ),
...
%GENERATED from file:friend.h => AddFriendRequest
readNetMsg(?CMD_AddFriendRequest,Bin0) ->
	{ V_friendName, Bin1 } = binary_read_string( Bin0 ),
	{ #pk_AddFriendRequest {
		friendName = V_friendName
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_AddBlackListResult
readNetMsg(?CMD_GS2U_AddBlackListResult,Bin0) ->
	{ V_resultcode, Bin1 } = binary_read_uint8( Bin0 ),
	{ #pk_GS2U_AddBlackListResult {
		resultcode = V_resultcode
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_AddFriendResult
readNetMsg(?CMD_GS2U_AddFriendResult,Bin0) ->
	{ V_resultcode, Bin1 } = binary_read_uint8( Bin0 ),
	{ #pk_GS2U_AddFriendResult {
		resultcode = V_resultcode
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_BlackInfo
readNetMsg(?CMD_GS2U_BlackInfo,Bin0) ->
	{ V_blackInfo, Bin1 } = readBlackOrNearbyinfo( Bin0 ),
	{ #pk_GS2U_BlackInfo {
		blackInfo = V_blackInfo
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_DelSomeoneResult
readNetMsg(?CMD_GS2U_DelSomeoneResult,Bin0) ->
	{ V_resultcode, Bin1 } = binary_read_uint8( Bin0 ),
	{ V_friendType, Bin2 } = binary_read_uint8( Bin1 ),
	{ V_playerID, Bin3 } = binary_read_uint64( Bin2 ),
	{ #pk_GS2U_DelSomeoneResult {
		resultcode = V_resultcode,
		friendType = V_friendType,
		playerID = V_playerID
		},
	Bin3 };

%GENERATED from file:friend.h => GS2U_FriendInfo
readNetMsg(?CMD_GS2U_FriendInfo,Bin0) ->
	{ V_friendInfo, Bin1 } = readFriendInfo( Bin0 ),
	{ #pk_GS2U_FriendInfo {
		friendInfo = V_friendInfo
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_FriendOffline
readNetMsg(?CMD_GS2U_FriendOffline,Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ #pk_GS2U_FriendOffline {
		friendID = V_friendID
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_FriendOnline
readNetMsg(?CMD_GS2U_FriendOnline,Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ V_friendCode, Bin2 } = binary_read_uint64( Bin1 ),
	{ #pk_GS2U_FriendOnline {
		friendID = V_friendID,
		friendCode = V_friendCode
		},
	Bin2 };

%GENERATED from file:friend.h => GS2U_LoadBlackFriendInfoList
readNetMsg(?CMD_GS2U_LoadBlackFriendInfoList,Bin0) ->
	{ V_blackInfoList, Bin1 } = binary_read_array(Bin0, fun(X) -> readBlackOrNearbyinfo( X ) end),
	{ #pk_GS2U_LoadBlackFriendInfoList {
		blackInfoList = V_blackInfoList
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_LoadFriendInfoList
readNetMsg(?CMD_GS2U_LoadFriendInfoList,Bin0) ->
	{ V_friendInfoList, Bin1 } = binary_read_array(Bin0, fun(X) -> readFriendInfo( X ) end),
	{ #pk_GS2U_LoadFriendInfoList {
		friendInfoList = V_friendInfoList
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_LoadNearByFriendInfoList
readNetMsg(?CMD_GS2U_LoadNearByFriendInfoList,Bin0) ->
	{ V_nearbyInfoList, Bin1 } = binary_read_array(Bin0, fun(X) -> readBlackOrNearbyinfo( X ) end),
	{ #pk_GS2U_LoadNearByFriendInfoList {
		nearbyInfoList = V_nearbyInfoList
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_LoadTempFriendInfoList
readNetMsg(?CMD_GS2U_LoadTempFriendInfoList,Bin0) ->
	{ V_tempInfoList, Bin1 } = binary_read_array(Bin0, fun(X) -> readTempInfo( X ) end),
	{ #pk_GS2U_LoadTempFriendInfoList {
		tempInfoList = V_tempInfoList
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_SearchFriendAck
readNetMsg(?CMD_GS2U_SearchFriendAck,Bin0) ->
	{ V_friendInfo, Bin1 } = readBlackOrNearbyinfo( Bin0 ),
	{ #pk_GS2U_SearchFriendAck {
		friendInfo = V_friendInfo
		},
	Bin1 };

%GENERATED from file:friend.h => GS2U_TempInfo
readNetMsg(?CMD_GS2U_TempInfo,Bin0) ->
	{ V_tempInfo, Bin1 } = readTempInfo( Bin0 ),
	{ #pk_GS2U_TempInfo {
		tempInfo = V_tempInfo
		},
	Bin1 };

%GENERATED from file:friend.h => U2GS_AddBlackListRequest
readNetMsg(?CMD_U2GS_AddBlackListRequest,Bin0) ->
	{ V_playerID, Bin1 } = binary_read_uint64( Bin0 ),
	{ #pk_U2GS_AddBlackListRequest {
		playerID = V_playerID
		},
	Bin1 };

%GENERATED from file:friend.h => U2GS_AddLove
readNetMsg(?CMD_U2GS_AddLove,Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ #pk_U2GS_AddLove {
		friendID = V_friendID
		},
...
%GENERATED from file:friend.h => U2GS_AddPeerFriendRequest
readNetMsg(?CMD_U2GS_AddPeerFriendRequest,Bin0) ->
	{ V_friendName, Bin1 } = binary_read_string( Bin0 ),
	{ #pk_U2GS_AddPeerFriendRequest {
		friendName = V_friendName
		},
	Bin1 };

%GENERATED from file:friend.h => U2GS_DelSomeoneRequest
readNetMsg(?CMD_U2GS_DelSomeoneRequest,Bin0) ->
	{ V_friendType, Bin1 } = binary_read_uint8( Bin0 ),
	{ V_playerID, Bin2 } = binary_read_uint64( Bin1 ),
	{ #pk_U2GS_DelSomeoneRequest {
		friendType = V_friendType,
		playerID = V_playerID
		},
	Bin2 };

%GENERATED from file:friend.h => U2GS_QurryNearbyFriendListRequest
readNetMsg(?CMD_U2GS_QurryNearbyFriendListRequest,Bin0) ->
	{ V_m_in, Bin1 } = binary_read_uint8( Bin0 ),
	{ #pk_U2GS_QurryNearbyFriendListRequest {
		m_in = V_m_in
		},
	Bin1 };

%GENERATED from file:friend.h => U2GS_SearchFriend
readNetMsg(?CMD_U2GS_SearchFriend,Bin0) ->
	{ V_friendName, Bin1 } = binary_read_string( Bin0 ),
	{ #pk_U2GS_SearchFriend {
		friendName = V_friendName
		},
	Bin1 };
...
readNetMsg(?CMD_GS2U_LookInfoPlayer,Bin0) ->
	...
	{ V_level, Bin9 } = binary_read_int16( Bin8 ),
	{ V_hp_per, Bin10 } = binary_read_uint8( Bin9 ),
	{ V_petID, Bin11 } = binary_read_uint16( Bin10 ),
	{ V_servername, Bin12 } = binary_read_string( Bin11 ),
	{ V_pkMode, Bin13 } = binary_read_uint8( Bin12 ),
	{ V_pet_list, Bin14 } = binary_read_array(Bin13, fun(X) -> binary_read_uint64( X ) end),
	{ V_move_list, Bin15 } = binary_read_array(Bin14, fun(X) -> readPosInfo( X ) end),
	{ V_buffs, Bin16 } = binary_read_array(Bin15, fun(X) -> readBuffBaseInfo( X ) end),
	{ V_visible_equips, Bin17 } = binary_read_array(Bin16, fun(X) -> readvisibleEquip( X ) end),
	{ V_refine_levels, Bin18 } = binary_read_array(Bin17, fun(X) -> readrefineLevel( X ) end),
...
readNetMsg(?CMD_GS2U_UserPlayerList,Bin0) ->
	{ V_info, Bin1 } = binary_read_array(Bin0, fun(X) -> readUserPlayerData( X ) end),
...
readNetMsg(?CMD_U2GS_WingRise,Bin0) ->
	{ V_itemID, Bin1 } = binary_read_uint( Bin0 ),
	{ V_useAll, Bin2 } = binary_read_bool( Bin1 ),
	{ #pk_U2GS_WingRise {
		itemID = V_itemID,
		useAll = V_useAll
		},
...
readNetMsg(?CMD_GS2U_SendPropList,Bin0) ->
	...
	{ V_career, Bin3 } = binary_read_int8( Bin2 ),
	{ V_equipIDList, Bin4 } = binary_read_array(Bin3, fun(X) -> readPlayerEquip( X ) end),
	{ V_equipLevelList, Bin5 } = binary_read_array(Bin4, fun(X) -> readPlayerEquipLevel( X ) end),
...
%GENERATED from file:task.h => GS2U_GetLoopTaskRewardResult
readNetMsg(?CMD_GS2U_GetLoopTaskRewardResult,Bin0) ->
	{ V_result, Bin1 } = binary_read_int( Bin0 ),
	{ #pk_GS2U_GetLoopTaskRewardResult {
		result = V_result
		},
	Bin1 };
...
%GENERATED from file:task.h => U2GS_RequestGetLoopTaskReward
readNetMsg(?CMD_U2GS_RequestGetLoopTaskReward,Bin0) ->
	{ #pk_U2GS_RequestGetLoopTaskReward {
...
%GENERATED from file:friend.h => BlackOrNearbyinfo
-spec readBlackOrNearbyinfo(Bin0) -> { #pk_BlackOrNearbyinfo{},LeftBin }
	when Bin0 :: binary(), LeftBin :: binary().
readBlackOrNearbyinfo(Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ V_friendName, Bin2 } = binary_read_string( Bin1 ),
	{ V_friendCareer, Bin3 } = binary_read_uint8( Bin2 ),
	{ V_friendLevel, Bin4 } = binary_read_uint16( Bin3 ),
	{ V_friendVip, Bin5 } = binary_read_uint8( Bin4 ),
	{ #pk_BlackOrNearbyinfo {
		friendID = V_friendID,
		friendName = V_friendName,
		friendCareer = V_friendCareer,
		friendLevel = V_friendLevel,
		friendVip = V_friendVip
		},
	Bin5 }.

%GENERATED from file:friend.h => FriendInfo
-spec readFriendInfo(Bin0) -> { #pk_FriendInfo{},LeftBin }
	when Bin0 :: binary(), LeftBin :: binary().
readFriendInfo(Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ V_friendCode, Bin2 } = binary_read_uint64( Bin1 ),
	{ V_friendName, Bin3 } = binary_read_string( Bin2 ),
	{ V_friendCareer, Bin4 } = binary_read_uint8( Bin3 ),
	{ V_friendLevel, Bin5 } = binary_read_uint16( Bin4 ),
	{ V_friendVip, Bin6 } = binary_read_uint8( Bin5 ),
	{ V_friendValue, Bin7 } = binary_read_uint( Bin6 ),
	{ V_friendOnline, Bin8 } = binary_read_uint8( Bin7 ),
	{ V_friendLuckyCoin, Bin9 } = binary_read_bool( Bin8 ),
	{ #pk_FriendInfo {
		friendID = V_friendID,
		friendCode = V_friendCode,
		friendName = V_friendName,
		...
		friendLevel = V_friendLevel,
		friendVip = V_friendVip,
		friendValue = V_friendValue,
		friendOnline = V_friendOnline,
		friendLuckyCoin = V_friendLuckyCoin
		},
	Bin9 }.

%GENERATED from file:friend.h => TempInfo
-spec readTempInfo(Bin0) -> { #pk_TempInfo{},LeftBin }
	when Bin0 :: binary(), LeftBin :: binary().
readTempInfo(Bin0) ->
	{ V_friendID, Bin1 } = binary_read_uint64( Bin0 ),
	{ V_friendName, Bin2 } = binary_read_string( Bin1 ),
	...
	{ V_friendLevel, Bin4 } = binary_read_uint16( Bin3 ),
	{ V_friendVip, Bin5 } = binary_read_uint8( Bin4 ),
	{ V_friendOnline, Bin6 } = binary_read_uint8( Bin5 ),
	{ #pk_TempInfo {
		friendID = V_friendID,
		friendName = V_friendName,
		friendCareer = V_friendCareer,
...
readRoleBaseInfo(Bin0) ->
	...
	{ V_vip, Bin9 } = binary_read_int8( Bin8 ),
	{ V_hp_per, Bin10 } = binary_read_uint8( Bin9 ),
	{ V_exp, Bin11 } = binary_read_uint( Bin10 ),
	{ V_maxExp, Bin12 } = binary_read_uint( Bin11 ),
	{ V_cur_hp, Bin13 } = binary_read_uint( Bin12 ),
	{ V_max_hp, Bin14 } = binary_read_uint( Bin13 ),
	{ V_mp, Bin15 } = binary_read_uint( Bin14 ),
	{ V_mountID, Bin16 } = binary_read_uint16( Bin15 ),
	{ V_pkMode, Bin17 } = binary_read_uint8( Bin16 ),
	{ V_maxCourage, Bin18 } = binary_read_uint16( Bin17 ),
	{ V_moneys, Bin19 } = binary_read_array(Bin18, fun(X) -> readMoneyInit( X ) end),
	{ V_visible_equips, Bin20 } = binary_read_array(Bin19, fun(X) -> readvisibleEquip( X ) end),
	{ V_refine_levels, Bin21 } = binary_read_array(Bin20, fun(X) -> readrefineLevel( X ) end),
	{ #pk_RoleBaseInfo {
		code = V_code,
		roleID = V_roleID,
		name = V_name,
...
readUserPlayerData(Bin0) ->
	...
	{ V_career, Bin6 } = binary_read_int8( Bin5 ),
	{ V_mapID, Bin7 } = binary_read_uint16( Bin6 ),
	{ V_oldMapID, Bin8 } = binary_read_uint16( Bin7 ),
	{ V_canRename, Bin9 } = binary_read_bool( Bin8 ),
	{ V_visible_equips, Bin10 } = binary_read_array(Bin9, fun(X) -> readvisibleEquip( X ) end),
	{ V_fashionList, Bin11 } = binary_read_array(Bin10, fun(X) -> binary_read_uint16( X ) end),
	{ V_refine_levels, Bin12 } = binary_read_array(Bin11, fun(X) -> readrefineLevel( X ) end),
	{ #pk_UserPlayerData {
		roleID = V_roleID,
		name = V_name,
		level = V_level,
...
readTeamMemberInfo(Bin0) ->
	...
	{ V_hpPercent, Bin6 } = binary_read_uint8( Bin5 ),
	{ V_mapID, Bin7 } = binary_read_uint16( Bin6 ),
	{ V_customInfo, Bin8 } = binary_read_string( Bin7 ),
	{ #pk_TeamMemberInfo {
		playerID = V_playerID,
		code = V_code,
		playerName = V_playerName,
