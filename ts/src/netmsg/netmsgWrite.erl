...
packNetMsg(#pk_GS2U_SevenMissionDataUpdate{} = P) ->
	...
	Bin_number = binary_write_uint8( P#pk_GS2U_SevenMissionDataUpdate.number ),
	Bin_max = binary_write_uint8( P#pk_GS2U_SevenMissionDataUpdate.max ),
...
packNetMsg(#pk_AddFriendRequest{} = P) ->
	Bin_friendName = binary_write_string( P#pk_AddFriendRequest.friendName ),
	[
		<<?CMD_AddFriendRequest:16/little>>,
		Bin_friendName
	];

%GENERATED from file:friend.h => GS2U_AddBlackListResult
packNetMsg(#pk_GS2U_AddBlackListResult{} = P) ->
	Bin_resultcode = binary_write_uint8( P#pk_GS2U_AddBlackListResult.resultcode ),
	[
		<<?CMD_GS2U_AddBlackListResult:16/little>>,
		Bin_resultcode
	];

%GENERATED from file:friend.h => GS2U_AddFriendResult
packNetMsg(#pk_GS2U_AddFriendResult{} = P) ->
	Bin_resultcode = binary_write_uint8( P#pk_GS2U_AddFriendResult.resultcode ),
	[
		<<?CMD_GS2U_AddFriendResult:16/little>>,
		Bin_resultcode
	];

%GENERATED from file:friend.h => GS2U_BlackInfo
packNetMsg(#pk_GS2U_BlackInfo{} = P) ->
	Bin_blackInfo = writeBlackOrNearbyinfo( P#pk_GS2U_BlackInfo.blackInfo ),
	[
		<<?CMD_GS2U_BlackInfo:16/little>>,
		Bin_blackInfo
	];

%GENERATED from file:friend.h => GS2U_DelSomeoneResult
packNetMsg(#pk_GS2U_DelSomeoneResult{} = P) ->
	Bin_resultcode = binary_write_uint8( P#pk_GS2U_DelSomeoneResult.resultcode ),
	Bin_friendType = binary_write_uint8( P#pk_GS2U_DelSomeoneResult.friendType ),
	Bin_playerID = binary_write_uint64( P#pk_GS2U_DelSomeoneResult.playerID ),
	[
		<<?CMD_GS2U_DelSomeoneResult:16/little>>,
		Bin_resultcode,
		Bin_friendType,
		Bin_playerID
	];
...
packNetMsg(#pk_GS2U_FriendInfo{} = P) ->
	Bin_friendInfo = writeFriendInfo( P#pk_GS2U_FriendInfo.friendInfo ),
	[
		<<?CMD_GS2U_FriendInfo:16/little>>,
		Bin_friendInfo
	];

%GENERATED from file:friend.h => GS2U_FriendOffline
packNetMsg(#pk_GS2U_FriendOffline{} = P) ->
	Bin_friendID = binary_write_uint64( P#pk_GS2U_FriendOffline.friendID ),
	[
		<<?CMD_GS2U_FriendOffline:16/little>>,
		Bin_friendID
	];

%GENERATED from file:friend.h => GS2U_FriendOnline
packNetMsg(#pk_GS2U_FriendOnline{} = P) ->
	Bin_friendID = binary_write_uint64( P#pk_GS2U_FriendOnline.friendID ),
	Bin_friendCode = binary_write_uint64( P#pk_GS2U_FriendOnline.friendCode ),
	[
		<<?CMD_GS2U_FriendOnline:16/little>>,
		Bin_friendID,
		Bin_friendCode
	];

%GENERATED from file:friend.h => GS2U_LoadBlackFriendInfoList
packNetMsg(#pk_GS2U_LoadBlackFriendInfoList{} = P) ->
	Bin_blackInfoList = binary_write_array(P#pk_GS2U_LoadBlackFriendInfoList.blackInfoList, fun(X) -> writeBlackOrNearbyinfo( X ) end),
	[
		<<?CMD_GS2U_LoadBlackFriendInfoList:16/little>>,
		Bin_blackInfoList
	];

%GENERATED from file:friend.h => GS2U_LoadFriendInfoList
packNetMsg(#pk_GS2U_LoadFriendInfoList{} = P) ->
	Bin_friendInfoList = binary_write_array(P#pk_GS2U_LoadFriendInfoList.friendInfoList, fun(X) -> writeFriendInfo( X ) end),
	[
		<<?CMD_GS2U_LoadFriendInfoList:16/little>>,
		Bin_friendInfoList
	];

%GENERATED from file:friend.h => GS2U_LoadNearByFriendInfoList
packNetMsg(#pk_GS2U_LoadNearByFriendInfoList{} = P) ->
	Bin_nearbyInfoList = binary_write_array(P#pk_GS2U_LoadNearByFriendInfoList.nearbyInfoList, fun(X) -> writeBlackOrNearbyinfo( X ) end),
	[
		<<?CMD_GS2U_LoadNearByFriendInfoList:16/little>>,
		Bin_nearbyInfoList
	];

%GENERATED from file:friend.h => GS2U_LoadTempFriendInfoList
packNetMsg(#pk_GS2U_LoadTempFriendInfoList{} = P) ->
	Bin_tempInfoList = binary_write_array(P#pk_GS2U_LoadTempFriendInfoList.tempInfoList, fun(X) -> writeTempInfo( X ) end),
	[
		<<?CMD_GS2U_LoadTempFriendInfoList:16/little>>,
		Bin_tempInfoList
	];

%GENERATED from file:friend.h => GS2U_SearchFriendAck
packNetMsg(#pk_GS2U_SearchFriendAck{} = P) ->
	Bin_friendInfo = writeBlackOrNearbyinfo( P#pk_GS2U_SearchFriendAck.friendInfo ),
	[
		<<?CMD_GS2U_SearchFriendAck:16/little>>,
		Bin_friendInfo
	];

%GENERATED from file:friend.h => GS2U_TempInfo
packNetMsg(#pk_GS2U_TempInfo{} = P) ->
	Bin_tempInfo = writeTempInfo( P#pk_GS2U_TempInfo.tempInfo ),
	[
		<<?CMD_GS2U_TempInfo:16/little>>,
		Bin_tempInfo
	];

%GENERATED from file:friend.h => U2GS_AddBlackListRequest
packNetMsg(#pk_U2GS_AddBlackListRequest{} = P) ->
	Bin_playerID = binary_write_uint64( P#pk_U2GS_AddBlackListRequest.playerID ),
	[
		<<?CMD_U2GS_AddBlackListRequest:16/little>>,
		Bin_playerID
	];

%GENERATED from file:friend.h => U2GS_AddLove
packNetMsg(#pk_U2GS_AddLove{} = P) ->
	Bin_friendID = binary_write_uint64( P#pk_U2GS_AddLove.friendID ),
	[
		<<?CMD_U2GS_AddLove:16/little>>,
		Bin_friendID
	];

%GENERATED from file:friend.h => U2GS_AddPeerFriendRequest
packNetMsg(#pk_U2GS_AddPeerFriendRequest{} = P) ->
	Bin_friendName = binary_write_string( P#pk_U2GS_AddPeerFriendRequest.friendName ),
	[
		<<?CMD_U2GS_AddPeerFriendRequest:16/little>>,
		Bin_friendName
	];

%GENERATED from file:friend.h => U2GS_DelSomeoneRequest
packNetMsg(#pk_U2GS_DelSomeoneRequest{} = P) ->
	Bin_friendType = binary_write_uint8( P#pk_U2GS_DelSomeoneRequest.friendType ),
	Bin_playerID = binary_write_uint64( P#pk_U2GS_DelSomeoneRequest.playerID ),
	[
		<<?CMD_U2GS_DelSomeoneRequest:16/little>>,
		Bin_friendType,
		Bin_playerID
	];

%GENERATED from file:friend.h => U2GS_QurryNearbyFriendListRequest
packNetMsg(#pk_U2GS_QurryNearbyFriendListRequest{} = P) ->
	Bin_m_in = binary_write_uint8( P#pk_U2GS_QurryNearbyFriendListRequest.m_in ),
	[
		<<?CMD_U2GS_QurryNearbyFriendListRequest:16/little>>,
		Bin_m_in
	];

%GENERATED from file:friend.h => U2GS_SearchFriend
packNetMsg(#pk_U2GS_SearchFriend{} = P) ->
	Bin_friendName = binary_write_string( P#pk_U2GS_SearchFriend.friendName ),
	[
		<<?CMD_U2GS_SearchFriend:16/little>>,
		Bin_friendName
	];
...
packNetMsg(#pk_GS2U_RequestJoinGuildList{} = P) ->
	Bin_requestList = binary_write_array(P#pk_GS2U_RequestJoinGuildList.requestList, fun(X) -> writeGuildMemberInfo( X ) end),
	[
...
packNetMsg(#pk_U2GS_WingRise{} = P) ->
	...
	Bin_useAll = binary_write_bool( P#pk_U2GS_WingRise.useAll ),
	[
...
packNetMsg(#pk_GS2U_GetLoopTaskRewardResult{} = P) ->
	Bin_result = binary_write_int( P#pk_GS2U_GetLoopTaskRewardResult.result ),
	[
		<<?CMD_GS2U_GetLoopTaskRewardResult:16/little>>,
		Bin_result
	];
...
packNetMsg(#pk_U2GS_RequestGetLoopTaskReward{}) ->
	[
		<<?CMD_U2GS_RequestGetLoopTaskReward:16/little>>
...
writeSevenDayMissionData( #pk_SevenDayMissionData{} = P ) ->
	...
	Bin_number = binary_write_uint8( P#pk_SevenDayMissionData.number ),
	Bin_max = binary_write_uint8( P#pk_SevenDayMissionData.max ),
...
writeBlackOrNearbyinfo( #pk_BlackOrNearbyinfo{} = P ) ->
	Bin_friendID = binary_write_uint64( P#pk_BlackOrNearbyinfo.friendID ),
	Bin_friendName = binary_write_string( P#pk_BlackOrNearbyinfo.friendName ),
	Bin_friendCareer = binary_write_uint8( P#pk_BlackOrNearbyinfo.friendCareer ),
	Bin_friendLevel = binary_write_uint16( P#pk_BlackOrNearbyinfo.friendLevel ),
	Bin_friendVip = binary_write_uint8( P#pk_BlackOrNearbyinfo.friendVip ),
	[
		Bin_friendID,
		Bin_friendName,
		Bin_friendCareer,
...
writeFriendInfo( #pk_FriendInfo{} = P ) ->
	Bin_friendID = binary_write_uint64( P#pk_FriendInfo.friendID ),
	Bin_friendCode = binary_write_uint64( P#pk_FriendInfo.friendCode ),
	Bin_friendName = binary_write_string( P#pk_FriendInfo.friendName ),
	Bin_friendCareer = binary_write_uint8( P#pk_FriendInfo.friendCareer ),
	Bin_friendLevel = binary_write_uint16( P#pk_FriendInfo.friendLevel ),
	Bin_friendVip = binary_write_uint8( P#pk_FriendInfo.friendVip ),
	Bin_friendValue = binary_write_uint( P#pk_FriendInfo.friendValue ),
	Bin_friendOnline = binary_write_uint8( P#pk_FriendInfo.friendOnline ),
	Bin_friendLuckyCoin = binary_write_bool( P#pk_FriendInfo.friendLuckyCoin ),
	[
		Bin_friendID,
		Bin_friendCode,
		Bin_friendName,
...
writeTempInfo( #pk_TempInfo{} = P ) ->
	Bin_friendID = binary_write_uint64( P#pk_TempInfo.friendID ),
	Bin_friendName = binary_write_string( P#pk_TempInfo.friendName ),
	Bin_friendCareer = binary_write_uint8( P#pk_TempInfo.friendCareer ),
	Bin_friendLevel = binary_write_uint16( P#pk_TempInfo.friendLevel ),
	Bin_friendVip = binary_write_uint8( P#pk_TempInfo.friendVip ),
	Bin_friendOnline = binary_write_uint8( P#pk_TempInfo.friendOnline ),
	[
		Bin_friendID,
		Bin_friendName,
		Bin_friendCareer,
...
writeUseItemGainGoodsTips( #pk_UseItemGainGoodsTips{} = P ) ->
	Bin_itemID = binary_write_uint16( P#pk_UseItemGainGoodsTips.itemID ),
