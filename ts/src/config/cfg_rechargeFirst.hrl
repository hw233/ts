%%: 声明
-ifndef(cfg_rechargeFirst).
-define(cfg_rechargeFirst, 1).

-record(rechargeFirstCfg, {
        %%: 作者:
        id,
        ...
        %%: 展示道具1
        %%: 参数设置方式改为[a,b,c,d]
        %%: 其中a若<30000,则表示该参数为道具[a,b,c]即为[道具id,道具数量,道具只发给x职业]。若c=0则表示该道具发给所有职业d代表是否显示光环特效0不显示1显示
        %%: 其中a若≥30000,则表示该参数为装备[a,b,c]即为[装备id,装备品质,装备只发给x职业]。若c=0则表示该装备发给所有职业d代表是否显示光环特效0不显示1显示
        %%: 例子：
