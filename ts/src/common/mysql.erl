...
addDBPool() ->
	...
	logger:info("Connect DB[~p:~p ~p]",[DBIP,DBPort,DBName]),
...
addLogDBPool() ->
	...
	logger:info("Connect LogDB[~p:~p ~p]",[DBIP,DBPort,DBName]),
...
addActiveCodeDBPool() ->
	...
	logger:info("Connect ActiveCodeDB[~p:~p ~p]",[DBIP,DBPort,DBName]),
...
addLoginDBPool() ->
	...
	logger:info("Connect LOGINDB[~p:~p ~p]",[LOGINDBIP, LOGINDBPort, LOGINDBName]),
