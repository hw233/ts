...
packNetMsg(#pk_GS2U_MarriageEngagementList_Ack{} = P) ->
	Bin_engagementList = binary_write_array(P#pk_GS2U_MarriageEngagementList_Ack.engagementList, fun(X) -> writeEngagementCell( X ) end),
	[
...
packNetMsg(#pk_GS2U_RedEnvelopeCreateHistoryAck{} = P) ->
	Bin_historyList = binary_write_array(P#pk_GS2U_RedEnvelopeCreateHistoryAck.historyList, fun(X) -> writeCreateRedHistory( X ) end),
	[
...
packNetMsg(#pk_GS2U_AddNewCompleteLoopTasks{} = P) ->
	...
	Bin_listTaskID = binary_write_array(P#pk_GS2U_AddNewCompleteLoopTasks.listTaskID, fun(X) -> binary_write_int( X ) end),
