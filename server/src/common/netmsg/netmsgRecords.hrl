...
-define(CMD_GS2U_FriendAdd_Ask,44197).
-record(pk_GS2U_FriendAdd_Ask,{
	id,
	name
	}).

-define(CMD_GS2U_FriendBlack_Sync,57821).
-record(pk_GS2U_FriendBlack_Sync,{
	listData,
	opType,
	id
	}).

-define(CMD_GS2U_FriendMutual_Sync,51288).
-record(pk_GS2U_FriendMutual_Sync,{
	listData,
	opType,
	id
	}).

-define(CMD_GS2U_FriendRecommend_Ack,12872).
-record(pk_GS2U_FriendRecommend_Ack,{
	listData
	}).

-define(CMD_GS2U_FriendTemp_Sync,50012).
-record(pk_GS2U_FriendTemp_Sync,{
	listData,
	opType,
	id
	}).

-define(CMD_U2GS_FriendActoinPoint_Request,36854).
-record(pk_U2GS_FriendActoinPoint_Request,{
	listId,
	opType
	}).

-define(CMD_U2GS_FriendBeAdd_Request,42670).
-record(pk_U2GS_FriendBeAdd_Request,{
	id
	}).

-define(CMD_U2GS_FriendBlack_Request,6427).
-record(pk_U2GS_FriendBlack_Request,{
	}).

-define(CMD_U2GS_FriendMutual_Request,53232).
-record(pk_U2GS_FriendMutual_Request,{
	}).

-define(CMD_U2GS_FriendRecommend_Request,39964).
-record(pk_U2GS_FriendRecommend_Request,{
	}).

-define(CMD_U2GS_FriendRelationChange_Request,63616).
-record(pk_U2GS_FriendRelationChange_Request,{
	id,
	name,
	opType
	}).

-define(CMD_U2GS_FriendSearch_Request,36360).
-record(pk_U2GS_FriendSearch_Request,{
	name
	}).

-define(CMD_U2GS_FriendTemp_Request,7244).
-record(pk_U2GS_FriendTemp_Request,{
	}).
...
-define(CMD_GS2U_MarriageBaseInfo_Ack,60019).
-record(pk_GS2U_MarriageBaseInfo_Ack,{
	weddingDay,
	weddingRingExp,
	weddingRingLv,
	teleportationCD,
...
-define(CMD_GS2U_MarriageBuild_Ack,18230).
-record(pk_GS2U_MarriageBuild_Ack,{
	}).

-define(CMD_GS2U_MarriageBuild_AskAnother,54029).
-record(pk_GS2U_MarriageBuild_AskAnother,{
	timeWait,
	suitorRoleID,
	suitorRoleName
	}).

-define(CMD_GS2U_MarriageCancel_Ack,58098).
-record(pk_GS2U_MarriageCancel_Ack,{
	}).

-define(CMD_GS2U_MarriageCancel_AskAnother,40161).
-record(pk_GS2U_MarriageCancel_AskAnother,{
	timeWait,
	proposerRoleID,
	proposerRoleName
	}).

-define(CMD_GS2U_MarriageCancel_AskForPay,46025).
-record(pk_GS2U_MarriageCancel_AskForPay,{
	timeWait,
	costCoinNumber,
	costCoinType
	}).

-define(CMD_GS2U_MarriageEngagementBuild_Ack,36039).
-record(pk_GS2U_MarriageEngagementBuild_Ack,{
	}).

-define(CMD_GS2U_MarriageEngagementBuild_AskAnother,12824).
-record(pk_GS2U_MarriageEngagementBuild_AskAnother,{
	timeWait,
	weddingID,
	weddingType,
	suitorRoleID,
...
-define(CMD_GS2U_MarriageEngagementCancel_Ack,36437).
-record(pk_GS2U_MarriageEngagementCancel_Ack,{
	}).

-define(CMD_GS2U_MarriageEngagementList_Ack,43397).
-record(pk_GS2U_MarriageEngagementList_Ack,{
	engagementList
	}).

-define(CMD_GS2U_MarriageWeddingBegin_Sync,42991).
-record(pk_GS2U_MarriageWeddingBegin_Sync,{
	engagement
	}).

-define(CMD_GS2U_MarriageWeddingBelessing_Ack,7682).
-record(pk_GS2U_MarriageWeddingBelessing_Ack,{
	roleID,
	roleName,
	belessing
	}).

-define(CMD_GS2U_MarriageWeddingFlower_Ack,60211).
-record(pk_GS2U_MarriageWeddingFlower_Ack,{
	}).

-define(CMD_GS2U_MarriageWeddingGiftCount_Ack,22675).
-record(pk_GS2U_MarriageWeddingGiftCount_Ack,{
	countFlowers,
	countCandies
	}).

-define(CMD_U2GS_MarriageBaseInfo_Request,56291).
-record(pk_U2GS_MarriageBaseInfo_Request,{
	}).

-define(CMD_U2GS_MarriageBuild_AnotherReply,16472).
-record(pk_U2GS_MarriageBuild_AnotherReply,{
	operationCode
	}).

-define(CMD_U2GS_MarriageBuild_Request,50298).
-record(pk_U2GS_MarriageBuild_Request,{
	}).

-define(CMD_U2GS_MarriageCancel_AnotherReply,10352).
-record(pk_U2GS_MarriageCancel_AnotherReply,{
	operationCode
	}).

-define(CMD_U2GS_MarriageCancel_ReplyToPay,33716).
-record(pk_U2GS_MarriageCancel_ReplyToPay,{
	operationCode
	}).

-define(CMD_U2GS_MarriageCancel_Request,39810).
-record(pk_U2GS_MarriageCancel_Request,{
	}).

-define(CMD_U2GS_MarriageEngagementBuild_AnotherReply,2475).
-record(pk_U2GS_MarriageEngagementBuild_AnotherReply,{
	operationCode
	}).

-define(CMD_U2GS_MarriageEngagementBuild_Request,10955).
-record(pk_U2GS_MarriageEngagementBuild_Request,{
	weddingID,
	weddingType
	}).

-define(CMD_U2GS_MarriageEngagementCancel_Request,27941).
-record(pk_U2GS_MarriageEngagementCancel_Request,{
	weddingID
	}).

-define(CMD_U2GS_MarriageEngagementList_Request,27909).
-record(pk_U2GS_MarriageEngagementList_Request,{
	}).

-define(CMD_U2GS_MarriageTeleportation_Request,11354).
-record(pk_U2GS_MarriageTeleportation_Request,{
	}).

-define(CMD_U2GS_MarriageWeddingBelessing_Request,546).
-record(pk_U2GS_MarriageWeddingBelessing_Request,{
	belessing
	}).

-define(CMD_U2GS_MarriageWeddingCandy_Request,55389).
-record(pk_U2GS_MarriageWeddingCandy_Request,{
	}).

-define(CMD_U2GS_MarriageWeddingFlower_Request,15751).
-record(pk_U2GS_MarriageWeddingFlower_Request,{
	}).

-define(CMD_U2GS_MarriageWeddingGiftCount_Request,62019).
-record(pk_U2GS_MarriageWeddingGiftCount_Request,{
	}).

-define(CMD_U2GS_MarriageWeddingInvite_Request,14633).
-record(pk_U2GS_MarriageWeddingInvite_Request,{
	}).

-define(CMD_U2GS_MarriageWeddingRedPacket_Request,61697).
-record(pk_U2GS_MarriageWeddingRedPacket_Request,{
	}).
...
-define(CMD_GS2U_ConfigRedEnvelopeInfoAck,46736).
-record(pk_GS2U_ConfigRedEnvelopeInfoAck,{
	red,
	canRob
	}).

-define(CMD_GS2U_RedEnvelopeCreateHistoryAck,34930).
-record(pk_GS2U_RedEnvelopeCreateHistoryAck,{
	historyList
	}).
...
-define(CMD_GS2U_addRedEnvelope,14812).
-record(pk_GS2U_addRedEnvelope,{
	redUID,
	sendRoleName
	}).

-record(pk_RedHistory,{
	redUID,
	roleName,
	createTime,
	targetType,
...
-define(CMD_U2GS_ConfigRedEnvelope,57473).
-record(pk_U2GS_ConfigRedEnvelope,{
	redType,
	targetType,
	targetUID,
	allNumber,
...
-define(CMD_U2GS_ConfigRedEnvelopeInfo,12043).
-record(pk_U2GS_ConfigRedEnvelopeInfo,{
	redUID,
	canRob
	}).

-define(CMD_U2GS_RedEnvelopeCreateHistory,26253).
-record(pk_U2GS_RedEnvelopeCreateHistory,{
	}).
